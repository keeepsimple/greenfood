...
const videos = [
  {
    id: 'noIKNgQ9jZ0',
    title: 'Cách chế biến Hotpot Ball ngon',
    description: 'Khám phá cách chế biến hotpot ball tuyệt ngon với kỹ thuật chuyên nghiệp',
    thumbnail: 'https://img.youtube.com/vi/noIKNgQ9jZ0/maxresdefault.jpg'
  },
  {
    id: 'mKq4JOfz6tk',
    title: 'Bí quyết làm viên hotpot ball đậm đà',
    description: 'Học cách làm viên hotpot ball với hương vị đậm đà, hấp dẫn',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Xem cách chế biến và sử dụng sản phẩm hotpot ball của chúng tôi 
            để có những bữa ăn ngon và đầy dinh dưỡng
          </p>
        </div>
                ...
                <div className="p-6 lg:p-8">
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-red-400 text-sm font-medium">YouTube Shorts</span>
                    </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-lime-400 to-green-400 rounded-3xl p-8 lg:p-12">
            ...
            <p className="text-gray-800 text-lg mb-6 max-w-2xl mx-auto">
              Theo dõi kênh YouTube của chúng tôi để cập nhật thêm nhiều video hướng dẫn 
              chế biến hotpot ball ngon và bổ dưỡng
            </p>
            <a 
